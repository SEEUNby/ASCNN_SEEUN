...
#===============
train_path = 'dataset/LR_HR/scale_x4/dataset_cpy1.h5'
val_path = '/home/wstation/Set5/'

save_as = 'ESPCN/checkpoint/scale_x4/baseline.pth'
th = 0.04
dilation= False
r = 4
dilker = 3
...
model = model.float()
# pretrained_path = 'ASFSR/checkpoint/scale_x2/th_04_dilk3.pth'
