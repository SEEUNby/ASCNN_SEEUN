...
#========================
train_path = 'dataset/LR_HR/scale_x3/dataset_cpy4.h5'
val_path = '/home/wstation/Set5/'

save_as = 'ASFSR/checkpoint/scale_x3/th_10_dilk3.pth'
th = 0.10
dilation= True
r = 4
dilker = 3
...
model = model.float()
pretrained_path = 'ASFSR/checkpoint/scale_x2/th_10_dilk3.pth'
...
for itr_part in range(start_from, itr_parts+1):
    ...
    for step in range (1, n_steps+1):
        ...
        predict = model(lr_batch, th, dilker, dilation)
