...
#======================
train_path = 'dataset/LR_HR/scale_x2/dataset_cpy3.h5'
val_path = '/home/wstation/Set5/'

save_as = 'SRCNN/checkpoint/scale_x2/r8_th_07_dilk3.pth'
th = 0.07
dilation= True
r = 8
dilker = 3
...
model = model.float()
# pretrained_path = 'ASFSR/checkpoint/scale_x2/th_07_dilk3.pth'
