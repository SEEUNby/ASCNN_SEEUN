...
from SRCNN.SRCNN_ASF import Net
import random
...
#========================
train_path = 'dataset/LR_HR/scale_x2/dataset_cpy4.h5'
val_path = '/home/wstation/Set5/'

save_as = 'SRCNN/checkpoint/scale_x2/r8_th_10_dilk3.pth'
th = 0.1
dilation= True
r = 8
dilker = 3
...
model = model.float()
# pretrained_path = 'ASFSR/checkpoint/scale_x2/th_09_dilk3.pth'
